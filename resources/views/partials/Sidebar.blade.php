                ...
                <template x-if="isPagesMenuOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        <li
                            ...
                            <a class="w-full" href="{{ route('admin.units') }}">Product Units</a>
                        </li>
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <a class="w-full" href="{{ route('admin.attributes') }}">
                                Product Attributes
                            </a>
                        </li>
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <a class="w-full" href="{{route('admin.opinions')}}">
                                Product Opinion
                            </a>
                        </li>
                        <li
                        ...
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <a class="w-full" href="{{ route('admin.categories') }}">Product Categories</a>
                        </li>
                    </ul>
                </template>
            </li>
